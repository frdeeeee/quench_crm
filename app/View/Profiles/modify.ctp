<div class="flat_area grid_16">
	...
	<p>您还没有激活您的赴美行程，请根据指导老师给您的留言，完成下面的表格并提交，以激活Check In功能</p>
</div>
<div class="box grid_16">
	<div class="block">
	<h4 class="section">您好：您的优势办指导老师给您的留言如下：</h4>	
	<p style="margin-left: 20px;margin-right:20px;color:blue"><?php echo $data['Profile']['teacher_notes']?></p>
	</div>
</div>
<div class="box grid_16">
	<h2 class="box_head grad_blue">修改我的激活表格</h2>
...
<?php 
	...
	echo $this->Form->input('Profile.id',array('type'=>'hidden','value'=>$data['Profile']['id']));
?>
			<fieldset>
				...
				<div class="clearfix">
					...
					<?php echo $data['Profile']['itinerary_notes']?>
					</textarea>
					...
					<fieldset>
						...
						<div class="clearfix">
							<textarea name="data[Profile][sevis_notes]" title="请填写详细的说明信息" class="tooltip autogrow"
								><?php echo $data['Profile']['sevis_notes']?></textarea>
							<div class="required_tag tooltip hover left" title="必填项目"></div>
						</div>
					</fieldset>
					<fieldset>
						...
						<div class="clearfix">
							<textarea name="data[Profile][social_insu_notes]" title="请填写详细的说明信息" class="tooltip autogrow"
								><?php echo $data['Profile']['social_insu_notes']?></textarea>
							<div class="required_tag tooltip hover left" title="必填项目"></div>
						</div>
					</fieldset>
					<?php
			...
			<fieldset>
				...
				<div>
					<input name="data[Profile][job_location]" title="请填写详细的说明信息"
						class="tooltip right" type="text" value="<?php echo $data['Profile']['job_location']?>">
			...
			<fieldset>
				...
				<div class="clearfix">
					<textarea name="data[Profile][job_description]" title="请填写详细的工作内容信息" class="tooltip autogrow"
						><?php echo $data['Profile']['job_description']?></textarea>
					<div class="required_tag tooltip hover left" title="必填项目"></div>
				</div>
			</fieldset>
			<fieldset>
				...
				<div>
					<input name="data[Profile][accommodation]" title="请填写详细信息"
						class="tooltip right" type="text" value="<?php echo $data['Profile']['accommodation']?>">
					<div class="required_tag tooltip hover left"
						title="必填项目"></div>
				</div>
			</fieldset>
			<fieldset>
				...
				<div class="clearfix">
					<textarea name="data[Profile][accom_conditions]" title="请填写住宿条件信息" class="tooltip autogrow"
						><?php echo $data['Profile']['accom_conditions']?></textarea>
					<div class="required_tag tooltip hover left" title="必填项目"></div>
				</div>
			</fieldset>
