...
<p>我是优势项目的<?php echo $data['User']['name']; ?>，我很高兴的通知您，您申请的<?php echo $data['Project']['name']; ?>已经进入正式的赴美阶段。</p>
<p>请您访问我们的服务平台<?php echo Router::url(array('controller'=>'Students','action'=>'login'),TRUE); ?>，我们将竭尽全力协助您尽快完成赴美所需准备的一切事宜。</p>
<ul>
