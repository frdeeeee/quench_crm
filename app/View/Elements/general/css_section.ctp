...
<?php 
	echo $this->Html->css(array(
			...
			//'tinyeditor/style',
			'slidernav/slidernav','syntax_highlighter/styles/shCore','syntax_highlighter/styles/shThemeDefault',
			'uitotop/css/ui.totop','fullcalendar/fullcalendar','isotope/isotope','elfinder/css/elfinder','tiptip/tipTip','uniform/css/uniform.aristo',
			'multiselect/css/ui.multiselect','selectbox/jquery.selectBox',
			//'colorpicker/css/colorpicker',
			'uistars/jquery.ui.stars.min',
			'themeroller/Aristo','text','grid','main',
			'theme/theme_base',
			'theme/header_slideout',
			//'theme/switcher1.php?default=layout_fixed','theme/switcher2.php?default=switcher',
			//'theme/switcher3.php?default=theme_blue','theme/switcher4.php?default=bg_wood','theme/switcher5.php?default=switcher',
			'buttons','ie','own_style'
		));
?>	
		<!-- Style Switcher  
