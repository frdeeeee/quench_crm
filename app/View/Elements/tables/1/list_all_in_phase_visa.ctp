						...
						<?php 
							...
							foreach ($data as $value) {
								...
								*/
								...
								echo '<td>',($value['ApplicantVisa']['sevis']==0)?'<b style="color:red">未交</b>':'<b style="color:green">已交</b>','</td>';
								echo '<td>',($value['ApplicantVisa']['ds2019']==0)?'<b style="color:red">未收到</b>':'<b style="color:green">已收到</b>','</td>';
